...
namespace BysApp1.Controllers
{
    public class StudentController : Controller
    {
        ...
        public async Task<IActionResult> StudentPanel()
        {
            ...
            var response = await _httpClient.GetAsync($"https://localhost:7136/api/Students/{studentId}");
            ...
            try
            {
                ...
                var nonConfirmedResponse = await _httpClient.GetAsync($"https://localhost:7136/api/NonConfirmedSelections/Student/{studentId}");
                ...
                var approvedResponse = await _httpClient.GetAsync($"https://localhost:7136/api/StudentCourseSelections/{studentId}");
                ...
                var coursesResponse = await _httpClient.GetAsync($"https://localhost:7136/api/Courses");
        ...
        public async Task<IActionResult> CourseSelection()
        {
            ...
            {
                // API'den dersleri al
                var response = await _httpClient.GetAsync("https://localhost:7136/api/Courses");
        ...
        public async Task<IActionResult> SubmitCourseSelections(List<int> selectedCourseIds)
        {
            ...
            foreach (var courseId in selectedCourseIds)
            {
                ...
                var response = await _httpClient.PostAsJsonAsync("https://localhost:7136/api/NonConfirmedSelections", nonConfirmedSelection);
        ...
        public async Task<IActionResult> StudentCourses(int studentId)
        {
            ...
            {
                // API'ye istek gönder
                var response = await _httpClient.GetAsync($"https://localhost:7136/api/StudentCourseSelections/{studentId}");
                if (response.IsSuccessStatusCode)
                {
        ...
        public async Task<IActionResult> UpdateStudent(int id, string newEmail, string newPassword, int? advisorID)
        {
            ...
            var response = await _httpClient.GetAsync($"https://localhost:7136/api/Students/{id}");
            if (!response.IsSuccessStatusCode)
            {
            ...
            var updateResponse = await _httpClient.PutAsync($"https://localhost:7136/api/Students/{id}", jsonContent);
            ...
            {
                var userResponse = await _httpClient.GetAsync($"https://localhost:7136/api/Users/{userIdString}");
                ...
                var updateUserResponse = await _httpClient.PutAsync($"https://localhost:7136/api/Users/{userIdString}", userJsonContent);
